      ...
      <div class="row"><!-- featues1 -->
        <div class=" col-md-4  col-xs-12 ">
          <div class="feat"> <!--my div -->
           ...
           <a href=" {{ route('prof.create.seance') }} " class="btn btn-primary">Start</a>
          </div>
        </div>
                   <div class=" col-md-4  col-xs-12 ">
          <div class="feat"> <!--my div -->
           ...
           <a href="{{ route('prof.list.seance')}}" class="btn btn-primary">Start</a>
          </div>
        </div>
        ...
        <div class=" col-md-4  col-xs-12 ">
          <div class="feat"> <!--my div -->
           ...
           <a href="{{ route('prof.historique.absence')}}" class="btn btn-primary">Start</a>
          </div>
        </div>
      </div>
    </div>
